...
module SCDP (
    ...
    output wire [31:0] dmem_addr,   // byte address from ALU
    output wire [31:0] dmem_wdata,  // aligned write data
    output wire        dmem_we,     // write enable  
    output wire        dmem_re,     // read  enable  
    output wire [3:0]  dmem_be,     // AXI WSTRB
    input  wire [31:0] dmem_rdata,  // 32-bit word from memory
